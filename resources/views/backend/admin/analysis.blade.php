             ...
             <div class="card radius-10 border-start border-0 border-3 border-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">State Delegates</p>
                            <h4 class="my-1 text-info">0</h4>
                            <p class="mb-0 font-13"> State Delegates</p>
                        </div>
               ...
               <div class="card-body">
                   <div class="d-flex align-items-center">
                       <div>
                           ...
                           <p class="mb-0 font-13">Total Participants</p>
                       </div>
          ...
          <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-success">
               <div class="card-body">
                   <div class="d-flex align-items-center">
                       <div>
                           <p class="mb-0 text-secondary">Total Officials</p>
                           <h4 class="my-1 text-success">0</h4>
                           <p class="mb-0 font-13">Total Officials</p>
                       </div>
               ...
               <div class="card-body">
                   <div class="d-flex align-items-center">
                       <div>
                           ...
                           <p class="mb-0 font-13">Total Coaches</p>
                       </div>
